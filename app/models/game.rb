class Game < ActiveRecord::Base
  ...
  def self.player_move_direction(unique_piece_id)
    if unique_piece_id[0] == "B" # Black should be on top
      player_direction = -1
    else
      player_direction = 1
    end
  ...
  def self.initialize_board(game_id)
    Board.create(coord:'00', is_occupied: true, game_id: game_id, unique_piece_id: 'B1')
    Board.create(coord:'02', is_occupied: true, game_id: game_id, unique_piece_id: 'B2')
    Board.create(coord:'04', is_occupied: true, game_id: game_id, unique_piece_id: 'B3')
    Board.create(coord:'06', is_occupied: true, game_id: game_id, unique_piece_id: 'B4')
    Board.create(coord:'11', is_occupied: true, game_id: game_id, unique_piece_id: 'B5')
    Board.create(coord:'13', is_occupied: true, game_id: game_id, unique_piece_id: 'B6')
    Board.create(coord:'15', is_occupied: true, game_id: game_id, unique_piece_id: 'B7')
    Board.create(coord:'17', is_occupied: true, game_id: game_id, unique_piece_id: 'B8')
    Board.create(coord:'20', is_occupied: true, game_id: game_id, unique_piece_id: 'B9')
    Board.create(coord:'22', is_occupied: true, game_id: game_id, unique_piece_id: 'B10')
    Board.create(coord:'24', is_occupied: true, game_id: game_id, unique_piece_id: 'B11')
    Board.create(coord:'26', is_occupied: true, game_id: game_id, unique_piece_id: 'B12')
    Board.create(coord:'30', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'31', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'32', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'33', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'34', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'35', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'36', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'37', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'40', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'41', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'42', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'43', is_occupied: false, game_id: game_id, unique_piece_id: '')
    Board.create(coord:'44', is_occupied: false, game_id: game_id, unique_piece_id: '')
    ...
    Piece.create(location: '04', is_king: false, game_id: game_id, unique_piece_id: 'B3')
    Piece.create(location: '06', is_king: false, game_id: game_id, unique_piece_id: 'B4')
    Piece.create(location: '11', is_king: false, game_id: game_id, unique_piece_id: 'B5')
    Piece.create(location: '13', is_king: false, game_id: game_id, unique_piece_id: 'B6')
    Piece.create(location: '15', is_king: false, game_id: game_id, unique_piece_id: 'B7')
    Piece.create(location: '17', is_king: false, game_id: game_id, unique_piece_id: 'B8')
    Piece.create(location: '20', is_king: false, game_id: game_id, unique_piece_id: 'B9')
    Piece.create(location: '22', is_king: false, game_id: game_id, unique_piece_id: 'B10')
